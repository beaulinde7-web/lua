...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "zejix hub",
   LoadingSubtitle = "by zejix",
   ...
   KeySettings = {
      Title = "zejix",
      Subtitle = "Key System",
      Note = "join sever for key", -- Use this to tell the user how to get a key
      FileName = "zejix", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://pastebin.com/raw/GC1cZ9im"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})

local MainTab = Window:CreateTab("🏡 Universil", nil) -- Title, Image
local MainSection = MainTab:CreateSection("main")

Rayfield:Notify({
   Title = "you executed the script",
   Content = "zejix hub loaded successfully",
   Duration = 5,
   Image = nil,
})
...
local Script tab = Window:CreateTab("Script tab", nil) -- Title, Image
local Section = Script tab:CreateSection("Script your heart out")
...
local Button = Script tab:CreateButton({
